...
Secure in-memory secret store with AES-style XOR encryption in C.

## 🚀 Overview
This repository contains a professional implementation of **C Secret Manager**. It is designed with clean code principles and focuses on functionality and reliability.
